\subsection{Analysis results} \label{sec:analysisresults}
...
\noindent 2.1 Acceleration, Reverse/braking relevance\newline
...
\noindent 2.2 Game setting relevance\newline
...
\noindent 3.1 Unintentional/accidental/unaccounted activation of the change camera setting\newline
...
\noindent 3.2 Active and intentional activation of the change camera setting\newline
...
\noindent 3.3 No activation of the change camera setting. Either optional or unsuccessful.\newline
...
\noindent 4.1 In-game steering difficulties: Overturning\newline
...
\noindent 4.2 Controller mechanics: Occasional unwilling turning \newline
...
\noindent 5.1 Observed postures of the test subjects during gameplay.\newline
...
\noindent 5.2 Subject comments during gameplay\newline
...
\noindent 5.3 In-game steering recovery observations\newline
...
\noindent 5.4 Observed plausible clothing difficulties\newline
...
From the responses given to the interview conducted after the test (which can be found in appendix XX), the following interpretations were made.
